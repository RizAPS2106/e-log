...
$pdf-> Ln(40);
$pdf->Cell(190,10,'DAFTAR WALI KELAS SMK NEGERI 2 CIMAHI',0,1,'C');
...
<?php
    $pdf->Cell(30,6,$key['nip'],1,0);
    $pdf->Cell(40,6,$key['nama'],1,0);
    $pdf->Cell(20,6,$keykel['nama_kelas'],1,0);
    $pdf->Cell(30,6,$key['jk'],1,0);
    $pdf->Cell(35,6,$key['alamat'],1,0);
    $pdf->Cell(35,6,$key['nohp'],1,1);
?>
